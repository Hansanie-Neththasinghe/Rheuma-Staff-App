...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(
      duration: const Duration(seconds: 3), // Duration for full progress and scaling
      vsync: this,
    )..forward();
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: CircleAvatar(
              radius: 160,
              backgroundColor: Color(0xFFAEDFF7).withOpacity(0.9), // Slightly transparent blue
            ),
          ),
          ...
          Positioned(
            ...
            child: CircleAvatar(
              radius: 90,
              backgroundColor: Color(0xFF81D4FA).withOpacity(0.8), // Slightly transparent blue
            ),
          ),
          ...
          Positioned(
            ...
            child: CircleAvatar(
              radius: 50,
              backgroundColor: Color(0xFFB3E5FC).withOpacity(0.9), // Light blue circle
            ),
          ),
              ...
              children: [
                Transform.rotate(
                  ...
                  child: Container(
                    ...
                    height: 150,
                    decoration: BoxDecoration(
                      color: Color(0xFF29B6F6).withOpacity(0.85), // Transparent blue triangle
                      boxShadow: [
                        BoxShadow(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Colors.black87, // Gray/Black color for the app name for simplicity
                    letterSpacing: 5,
                    shadows: [
                      Shadow(
                        blurRadius: 10.0,
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Colors.black54, // Slightly lighter gray for the "CONNECT" text
                    letterSpacing: 3,
                  ),
                ),
                SizedBox(height: 20),
                ...
                return Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      value: _controller!.value, // Progress bar value controlled by animation
